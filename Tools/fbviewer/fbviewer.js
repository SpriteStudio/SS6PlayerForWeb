// 読み込むファイルはここを変更する
var ssfbPath = "../../Player/character_sample1/ss6ptest.ssbp.ssfb";

var index = ssfbPath.lastIndexOf("/");
var rootPath = ssfbPath.substring(0, index) + "/";

var fbObj; // flatbuffer builder
...
httpObj.onload = function() {
    ...
    fbObj = new ss.ssfb.ProjectData.getRootAsProjectData(buf);
    document.open();
    ...
    for (var i = 0; i < fbObj.cellsLength(); i++) {
    ...
    for (var i = 0; i < fbObj.animePacksLength(); i++) {
        document.writeln(i + ":{<br><div style=\"padding: 0px 10px;\">");
        ...
        for (var j = 0; j < fbObj.animePacks(i).partsLength(); j++) {
        ...
        for (var j = 0; j < fbObj.animePacks(i).animationsLength(); j++) {
            document.writeln(j + ":{<br><div style=\"padding: 0px 10px;\">");
            ...
            for (var k = 0; k < fbObj.animePacks(i).animations(j).defaultDataLength(); k++) {
            ...
            for (var k = 0; k < fbObj.animePacks(i).animations(j).frameDataLength(); k++) {
                document.writeln(k + ":{<br><div style=\"padding: 0px 10px;\">");
                document.write("data(int)[" + fbObj.animePacks(i).animations(j).frameData(k).dataLength() + "]:[");
                for (var l = 0; l < fbObj.animePacks(i).animations(j).frameData(k).dataLength(); l++) {
            ...
            for (var k = 0; k < fbObj.animePacks(i).animations(j).userDataLength(); k++) {
                document.writeln(k + ":{<br><div style=\"padding: 0px 10px;\">");
                ...
                for (var l = 0; l < fbObj.animePacks(i).animations(j).userData(k).dataLength(); l++) {
                    document.writeln(k + ":{<br><div style=\"padding: 0px 10px;\">");
                    ...
                    for (var m = 0; m < fbObj.animePacks(i).animations(j).userData(k).data(l).dataLength(); m++) {
                        var type = fbObj.animePacks(i).animations(j).userData(k).data(l).dataType(m);
            ...
            for (var k = 0; k < fbObj.animePacks(i).animations(j).labelDataLength(); k++) {
                document.writeln(k + ":{<br><div style=\"padding: 0px 10px;\">");
            ...
            for (var k = 0; k < fbObj.animePacks(i).animations(j).meshsDataUVLength(); k++) {
                document.writeln(k + ":{<br><div style=\"padding: 0px 10px;\">");
                document.write("data(float)[" + fbObj.animePacks(i).animations(j).meshsDataUV(k).uvLength() + "]:[");
                for (var l = 0; l < fbObj.animePacks(i).animations(j).meshsDataUV(k).uvLength(); l++) {
            ...
            for (var k = 0; k < fbObj.animePacks(i).animations(j).meshsDataIndicesLength(); k++) {
                document.writeln(k + ":{<br><div style=\"padding: 0px 10px;\">");
                // indices : [float];
                document.write("data(float)[" + fbObj.animePacks(i).animations(j).meshsDataIndices(k).indicesLength() + "]:[");
                for (var l = 0; l < fbObj.animePacks(i).animations(j).meshsDataIndices(k).indicesLength(); l++) {
    ...
    for (var i = 0; i < fbObj.effectFileListLength(); i++) {
        document.writeln(i + ":{<br><div style=\"padding: 0px 10px;\">");
        ...
        for (var j = 0; j < fbObj.effectFileList(i).effectNodeLength(); j++) {
            document.writeln(j + ":{<br><div style=\"padding: 0px 10px;\">");
            ...
            for (var k = 0; k < fbObj.effectFileList(i).effectNode(j).BehaviorLength(); k++) {
                var type = fbObj.effectFileList(i).effectNode(j).BehaviorType(k);
                ...
                if (type == ss.ssfb.EffectNodeBehavior.EffectParticleElementRndSpeedChange) {
                    document.writeln("(EffectParticleElementRndSpeedChange)[Seed(int):" + fbObj.effectFileList(i).effectNode(j).Behavior(k, new ss.ssfb.EffectParticleElementRndSpeedChange()).Seed() + "],<br>");
                }
                ...
                if (type == ss.ssfb.EffectNodeBehavior.EffectParticlePointGravity) {
                    document.writeln("(EffectParticlePointGravity)[Position_x(float):" + fbObj.effectFileList(i).effectNode(j).Behavior(k, new ss.ssfb.EffectParticlePointGravity()).Position_x() + ",");
                    document.writeln("Position_y(float):" + fbObj.effectFileList(i).effectNode(j).Behavior(k, new ss.ssfb.EffectParticlePointGravity()).Position_y() + ",");
